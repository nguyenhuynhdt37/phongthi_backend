...
class ToolWolframAlpha {
    constructor() {
        this.description = {
            ...
            outputs: ["ai_tool"],
            outputNames: ['Tool'],
            properties: [(0, sharedFields_1.getConnectionHintNoticeField)(["ai_agent"])],
        };
    }
    async supplyData() {
        const credentials = await this.getCredentials('wolframAlphaApi');
        return {
            response: (0, logWrapper_1.logWrapper)(new wolframalpha_1.WolframAlphaTool({ appid: credentials.appId }), this),
        };
    }
}
