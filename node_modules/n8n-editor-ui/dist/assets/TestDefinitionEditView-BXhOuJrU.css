...
._evaluationTooltip_1h8fm_133.el-popper {
...
._icon_1h8fm_141._warning_1h8fm_150 {
...
._evaluationStep_1h8fm_123:hover ._infoTip_1h8fm_172 {
  opacity: 1;
}
._actions_1h8fm_180 {
  margin-left: auto;
...
._cardContent_1h8fm_186 {
  font-size: var(--font-size-s);
  padding: 0 var(--spacing-s);
  margin: var(--spacing-s) 0;
}
._cardContentWrapper_1h8fm_192 {
  border-top: var(--border-base);
}
._has-issues_1h8fm_196 {
  /**
...
._isTrigger_7xdc7_127 {
  --canvas-node--border-color: var(--color-secondary);
}
._container_7xdc7_131 {
  width: 100%;
  height: 100%;
  border: 1px solid var(--color-foreground-light);
  border-radius: 8px;
}
._pinButtonContainer_7xdc7_138 {
  position: absolute;
  right: 50%;
  bottom: -5px;
...
._pinButtonContainer_7xdc7_138._pinButtonContainerPinned_7xdc7_149 {
  background-color: var(--color-secondary);
}
._customSecondary_7xdc7_153 {
...
/* BEM
 -------------------------- */
._pinnigModal_1qbos_123 {
  --dialog-max-width: none;
  margin: 0;
}
._nestedSteps_1qbos_128 {
  display: grid;
  grid-template-columns: 20% 1fr;
}
._tagInputTag_1qbos_133 {
  display: flex;
  gap: var(--spacing-3xs);
...
._contentWithRuns_1o8sl_133 ._config_1o8sl_130 {
  width: 400px;
}
._header_1o8sl_137 {
  display: flex;
...
._description_1o8sl_156 {
  max-width: 600px;
  margin-bottom: 20px;
}
._arrowBack_1o8sl_161 {
