...
.chat-inputs[data-v-9f775274] {
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: flex-end;
}
.chat-inputs textarea[data-v-9f775274] {
  font-family: inherit;
...
.chat-inputs textarea[data-v-9f775274]::-moz-placeholder {
  font-size: var(--chat--input--placeholder--font-size, var(--chat--input--font-size));
}
.chat-inputs textarea[data-v-9f775274]::placeholder {
  font-size: var(--chat--input--placeholder--font-size, var(--chat--input--font-size));
}
.chat-inputs textarea[data-v-9f775274]:focus, .chat-inputs textarea[data-v-9f775274]:hover {
  border-color: var(--chat--input--border-active, 0);
}
.chat-inputs-controls[data-v-9f775274] {
  display: flex;
}
.chat-input-send-button[data-v-9f775274],
.chat-input-file-button[data-v-9f775274] {
...
.chat-input-send-button svg[data-v-9f775274],
.chat-input-file-button svg[data-v-9f775274] {
  min-width: -moz-fit-content;
  min-width: fit-content;
}
.chat-input-send-button[disabled][data-v-9f775274],
.chat-input-file-button[disabled][data-v-9f775274] {
  cursor: no-drop;
  color: var(--chat--color-disabled);
}
.chat-input-send-button .chat-input-send-button[data-v-9f775274]:hover, .chat-input-send-button .chat-input-send-button[data-v-9f775274]:focus,
.chat-input-file-button .chat-input-send-button[data-v-9f775274]:hover,
.chat-input-file-button .chat-input-send-button[data-v-9f775274]:focus {
...
.chat-input-left-panel[data-v-9f775274] {
...
._sessionId_9tbjh_173 {
  display: inline-block;
  white-space: nowrap;
  text-overflow: ellipsis;
  overflow: hidden;
}
._sessionId_9tbjh_173._copyable_9tbjh_179 {
  cursor: pointer;
}
._headerButton_9tbjh_183 {
  max-height: 1.1rem;
  border: none;
}
._chatBody_9tbjh_188 {
...
._messages_9tbjh_194:not(:last-child) {
  margin-right: 1em;
}
._messagesInput_9tbjh_205 {
...
[data-theme=dark] ._messagesInput_9tbjh_205 {
...
._messagesInput_9tbjh_205:focus-within {
...
._logsHeader_1s52w_123 span {
  font-weight: 100;
}
._logsWrapper_1s52w_140 {
