const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-BIlQb2s0.js","assets/index-hwnaXsl6.js","assets/index-74EeM2i2.css","assets/useCanvasOperations-DrnL3tRC.js","assets/usePinnedData-Cgqy0XqK.js","assets/NodeCreator-DDiuO5S0.css"])))=>i.map(i=>d[i]);
import { bs as useNodeTypesStore, q as computed, c as useI18n, T as useWorkflowsStore, eY as MANUAL_TRIGGER_NODE_TYPE, gO as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bg as NodeConnectionType, bh as CHAT_TRIGGER_NODE_TYPE, gP as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, gQ as OPEN_AI_NODE_TYPE, eQ as SPLIT_IN_BATCHES_NODE_TYPE, gR as NO_OP_NODE_TYPE, eT as WEBHOOK_NODE_TYPE, e_ as SCHEDULE_TRIGGER_NODE_TYPE, aP as useExternalHooks, a1 as useCanvasStore, eh as AI_CATEGORY_LANGUAGE_MODELS, gS as QA_CHAIN_NODE_TYPE, gT as AGENT_NODE_TYPE, gU as BASIC_CHAIN_NODE_TYPE, gV as OPEN_AI_ASSISTANT_NODE_TYPE, ay as STICKY_NODE_TYPE, eW as TRIGGER_NODE_CREATOR_VIEW, bV as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, L as useUIStore, r as ref, fz as useThrottleFn, o as onMounted, y as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, by as KeyboardShortcutTooltip, bN as defineAsyncComponent, bM as Suspense, F as Fragment, ao as __vitePreload, gW as getMidCanvasPosition, gX as DEFAULT_STICKY_WIDTH, gY as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-hwnaXsl6.js";
import { u as useNodeCreatorStore, t as transformNodeType, s as sortNodeCreateElements } from "./useCanvasOperations-DrnL3tRC.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-BIlQb2s0.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0)
    );
    const props = __props;
    const emit = __emit;
