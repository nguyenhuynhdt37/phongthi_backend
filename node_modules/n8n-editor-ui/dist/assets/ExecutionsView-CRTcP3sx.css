...
/* BEM
 -------------------------- */
tr._dangerBg_rruph_123 {
  background-color: rgba(215, 56, 58, 0.1);
}
._capitalize_rruph_127 {
...
._execListHeaderControls_1tnmy_138 {
  display: flex;
  align-items: center;
  justify-content: flex-start;
  margin-bottom: var(--spacing-s);
}
._selectionOptions_1tnmy_145 {
  display: flex;
  align-items: center;
  position: absolute;
...
._selectionOptions_1tnmy_145 button {
  margin-left: var(--spacing-2xs);
}
._execTable_1tnmy_163 {
  height: 100%;
  flex: 0 1 auto;
}/* BEM support Func
 -------------------------- */
...
/* BEM
 -------------------------- */
.execFilter[data-v-2386cfef] button {
  height: 40px;
}
[data-v-2386cfef] .el-checkbox {
  display: inline-flex;
  align-items: center;
