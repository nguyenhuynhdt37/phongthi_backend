...
:root ._blockContent_kaw5r_171 {
  height: 0;
  overflow: hidden;
}
:root ._blockContent_kaw5r_171._blockContentExpanded_kaw5r_175 {
  height: auto;
}
._runText_kaw5r_179 {
  line-height: var(--font-line-height-xloose);
...
._block_kaw5r_164:hover ._rawSwitch_kaw5r_184 {
  opacity: 1;
}
._blockHeader_kaw5r_194 {
  display: flex;
  gap: var(--spacing-xs);
  cursor: pointer;
...
._blockTitle_kaw5r_207 {
  font-size: var(--font-size-s);
  color: var(--color-text-dark);
  margin: 0;
  padding-bottom: var(--spacing-4xs);
}
._blockToggle_kaw5r_214 {
  border: none;
  background: none;
  padding: 0;
  color: var(--color-text-base);
