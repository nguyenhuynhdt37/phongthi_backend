...
let WorkflowHistoryController = class WorkflowHistoryController {
    ...
    async getList(req) {
        try {
            return await this.historyService.getList(req.user, req.params.workflowId, req.query.take ?? DEFAULT_TAKE, req.query.skip ?? 0);
        }
        catch (e) {
...
], WorkflowHistoryController.prototype, "workflowHistoryLicense", null);
__decorate([
    (0, decorators_1.Middleware)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", void 0)
], WorkflowHistoryController.prototype, "workflowHistoryEnabled", null);
__decorate([
    (0, decorators_1.Get)('/workflow/:workflowId', { middlewares: [pagination_1.paginationListQueryMiddleware] }),
    __metadata("design:type", Function),
