...
let FrontendService = class FrontendService {
    constructor(globalConfig, logger, loadNodesAndCredentials, credentialTypes, credentialsOverwrites, license, mailer, instanceSettings, urlService, securityConfig) {
    ...
    getSettings() {
        ...
        this.settings.folders.enabled = config_2.default.get('folders.enabled');
