...
let DynamicNodeParametersController = class DynamicNodeParametersController {
    ...
    async getOptions(req, _res, payload) {
        const { credentials, currentNodeParameters, nodeTypeAndVersion, path, methodName, loadOptions, } = payload;
    ...
    async getResourceLocatorResults(req, _res, payload) {
        const { path, methodName, filter, paginationToken, credentials, currentNodeParameters, nodeTypeAndVersion, } = payload;
        const additionalData = await (0, workflow_execute_additional_data_1.getBase)(req.user.id, currentNodeParameters);
