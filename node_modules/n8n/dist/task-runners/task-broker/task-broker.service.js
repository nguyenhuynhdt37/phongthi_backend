...
const task_runner_timeout_error_1 = require("../../task-runners/task-broker/errors/task-runner-timeout.error");
...
let TaskBroker = class TaskBroker {
    ...
    async handleTaskTimeout(taskId) {
        ...
        await this.taskErrorHandler(taskId, new task_runner_timeout_error_1.TaskRunnerTimeoutError({
            taskTimeout,
