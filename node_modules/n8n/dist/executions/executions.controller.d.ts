...
export declare class ExecutionsController {
    ...
    getOne(req: ExecutionRequest.GetOne): Promise<import("../interfaces").IExecutionResponse | import("../interfaces").IExecutionFlattedResponse | undefined>;
    stop(req: ExecutionRequest.Stop): Promise<import("./execution.types").StopResult>;
    retry(req: ExecutionRequest.Retry): Promise<boolean>;
    delete(req: ExecutionRequest.Delete): Promise<void>;
    update(req: ExecutionRequest.Update): Promise<import("../interfaces").IExecutionResponse | import("../interfaces").IExecutionFlattedResponse | undefined>;
}
