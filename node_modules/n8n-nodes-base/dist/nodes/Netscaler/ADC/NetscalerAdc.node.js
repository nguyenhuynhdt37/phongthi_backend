            ...
            try {
                if (resource === 'file') {
                    if (operation === 'upload') {
                        ...
                        await GenericFunctions_1.netscalerADCApiRequest.call(this, 'POST', endpoint, body);
                    ...
                    if (operation === 'delete') {
                        ...
                        await GenericFunctions_1.netscalerADCApiRequest.call(this, 'DELETE', endpoint);
                        responseData = { success: true };
                    }
                    if (operation === 'download') {
                        ...
                        const binaryProperty = this.getNodeParameter('binaryProperty', i);
                        const endpoint = `/config/systemfile?args=filename:${fileName},filelocation:${encodeURIComponent(fileLocation)}`;
                        const { systemfile } = await GenericFunctions_1.netscalerADCApiRequest.call(this, 'GET', endpoint);
                ...
                if (resource === 'certificate') {
                    if (operation === 'create') {
                        ...
                        await GenericFunctions_1.netscalerADCApiRequest.call(this, 'POST', endpoint, { sslcert: body });
                        responseData = { success: true };
                    }
                    if (operation === 'install') {
                        ...
                        await GenericFunctions_1.netscalerADCApiRequest.call(this, 'POST', endpoint, { sslcertkey: body });
                        responseData = { success: true };
                    }
                }
...
exports.NetscalerAdc = NetscalerAdc;
