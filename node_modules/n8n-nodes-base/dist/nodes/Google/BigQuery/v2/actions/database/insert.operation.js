...
async function execute() {
    ...
    const schema = (await transport_1.googleBigQueryApiRequest.call(this, 'GET', `/v2/projects/${projectId}/datasets/${datasetId}/tables/${tableId}`, {})).schema;
    if (schema === undefined) {
    ...
    for (let i = 0; i < rows.length; i += batchSize) {
        ...
        body.rows = batch;
        const responseData = await transport_1.googleBigQueryApiRequest.call(this, 'POST', `/v2/projects/${projectId}/datasets/${datasetId}/tables/${tableId}/insertAll`, body);
