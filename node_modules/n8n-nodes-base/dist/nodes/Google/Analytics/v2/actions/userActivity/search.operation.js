...
async function execute(index) {
    ...
    if (returnAll) {
        responseData = await transport_1.googleApiRequestAllItems.call(this, 'sessions', method, endpoint, body);
    }
    else {
        body.pageSize = this.getNodeParameter('limit', 0);
        responseData = await transport_1.googleApiRequest.call(this, method, endpoint, body);
