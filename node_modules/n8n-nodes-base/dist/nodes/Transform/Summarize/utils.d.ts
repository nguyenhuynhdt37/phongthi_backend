...
export declare const fieldValueGetter: (disableDotNotation?: boolean) => (item: IDataObject, field: string) => IDataObject | GenericValue | GenericValue[] | IDataObject[];
...
export declare function aggregationToArrayWithOriginalTypes(aggregationResult: IDataObject, fieldsToSplitBy: string[], previousStage?: IDataObject): IDataObject[];
export {};
