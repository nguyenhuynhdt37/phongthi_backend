...
class Summarize {
    ...
    async execute() {
        ...
        if (options.outputFormat === 'singleItem') {
            ...
            let returnData = [];
            if (nodeVersion > 1) {
                returnData = (0, utils_1.aggregationToArrayWithOriginalTypes)(aggregationResult, fieldsToSplitBy);
            }
            else {
                returnData = (0, utils_1.aggregationToArray)(aggregationResult, fieldsToSplitBy);
            }
