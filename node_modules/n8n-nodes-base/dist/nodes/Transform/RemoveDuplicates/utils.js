...
function removeDuplicateInputItems(context, items) {
    ...
    newItems.sort((a, b) => {
        ...
        for (const key of keys) {
            let equal;
            if (!disableDotNotation) {
                equal = (0, lodash_1.isEqual)((0, get_1.default)(a.json, key), (0, get_1.default)(b.json, key));
            }
            else {
            ...
            if (!equal) {
                let lessThan;
                if (!disableDotNotation) {
                    lessThan = (0, lodash_1.lt)((0, get_1.default)(a.json, key), (0, get_1.default)(b.json, key));
                }
                else {
    ...
    if (removeOtherFields) {
        updatedItems = updatedItems.map((item, index) => ({
            json: (0, lodash_1.pick)(item.json, ...keys),
            pairedItem: { item: index },
        }));
    }
    return [updatedItems];
