            ...
            message: {
                async [n8n_workflow_1.SEND_AND_WAIT_OPERATION]() {
                    try {
                        ...
                        await this.helpers.httpRequestWithAuthentication.call(this, WHATSAPP_CREDENTIALS_TYPE, (0, GenericFunctions_1.createMessage)(config, phoneNumberId, recipientPhoneNumber));
