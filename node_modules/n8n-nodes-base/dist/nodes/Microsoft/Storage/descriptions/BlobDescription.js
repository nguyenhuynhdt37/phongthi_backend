        ...
        options: [
            {
                ...
                routing: {
                    request: {
                        ...
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_DATE]: '={{ new Date().toUTCString() }}',
                            [GenericFunctions_1.HeaderConstants.X_MS_VERSION]: GenericFunctions_1.XMsVersion,
                        },
                    },
                    output: {
                        postReceive: [
                            ...
                            async function (_data, response) {
                                return [
                                    {
                                        json: (0, GenericFunctions_1.parseHeaders)(response.headers),
                                    },
                                ];
                            },
                        ],
                        ...
                        postReceive: [
                            ...
                            async function (_data, response) {
                                ...
                                if (headerData.contentDisposition) {
                                    let fileNameMatch = /filename\*=(?:(\\?['"])(.*?)\1|(?:[^\s]+'.*?')?([^;\n]*))/g.exec(headerData.contentDisposition);
                                    fileName =
                                    ...
                                    if (fileName) {
                                        ...
                                        fileNameMatch = /filename="?([^"]*?)"?(;|$)/g.exec(headerData.contentDisposition);
                                        fileName =
                                            fileNameMatch && fileNameMatch.length > 1 ? fileNameMatch[1] : undefined;
                                    }
                                }
                                newItem.binary.data = await this.helpers.prepareBinaryData(response.body, fileName, headerData.contentType);
                                return [newItem];
                            },
                        ],
                    },
                    ...
                    output: {
                        postReceive: [
                            ...
                            async function (data, _response) {
                                const bodyData = await (0, GenericFunctions_1.parseBlobList)(data[0].json);
                                if (this.getNodeParameter('options.simplify', true)) {
                                    for (const blob of bodyData.blobs) {
                                        const properties = blob.properties;
                                        if (!properties.cacheControl)
                                            delete properties.cacheControl;
                                        if (!properties.contentCRC64)
                                            delete properties.contentCRC64;
                                        if (!properties.contentEncoding)
                                            delete properties.contentEncoding;
                                        if (!properties.contentLanguage)
                                            delete properties.contentLanguage;
                                        if (!properties.contentDisposition)
                                            delete properties.contentDisposition;
            ...
            send: {
                preSend: [
                    async function (requestOptions) {
                        ...
                        requestOptions.headers[GenericFunctions_1.HeaderConstants.CONTENT_LENGTH] = binaryDataBuffer.length;
                        requestOptions.headers[GenericFunctions_1.HeaderConstants.X_MS_BLOB_TYPE] = 'BlockBlob';
                        if (binaryData.mimeType) {
                            requestOptions.headers[GenericFunctions_1.HeaderConstants.CONTENT_TYPE] = binaryData.mimeType;
                        }
                        if (binaryData.fileName) {
                            requestOptions.headers[GenericFunctions_1.HeaderConstants.X_MS_BLOB_CONTENT_DISPOSITION] =
            ...
            send: {
                preSend: [
                    async function (requestOptions) {
                        ...
                        requestOptions.headers ??= {};
                        requestOptions.headers[GenericFunctions_1.HeaderConstants.X_MS_BLOB_TYPE] = 'BlockBlob';
                        requestOptions.headers[GenericFunctions_1.HeaderConstants.X_MS_COPY_SOURCE] = url;
                        return requestOptions;
                    },
                ],
            },
        ...
        options: [
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_ACCESS_TIER]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'options',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_BLOB_TYPE]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'options',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_BLOB_CACHE_CONTROL]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_CONTENT_CRC64]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_BLOB_CONTENT_ENCODING]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_BLOB_CONTENT_LANGUAGE]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_BLOB_CONTENT_MD5]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_BLOB_CONTENT_TYPE]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_ENCRYPTION_CONTEXT]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_ENCRYPTION_SCOPE]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_EXPIRY_OPTION]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'options',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_EXPIRY_TIME]: '={{ $value ? DateTime.fromISO($value).format("EEE, dd MMM yyyy HH:mm:ss ZZZ") : undefined }}',
                        },
                    },
                },
                type: 'dateTime',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_BLOB_CONTENT_DISPOSITION]: "={{ $value ? 'attachment; filename=\"' + $value + '\"' : undefined }}",
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_IMMUTABILITY_POLICY_UNTIL_DATE]: '={{ $value ? DateTime.fromISO($value).format("EEE, dd MMM yyyy HH:mm:ss ZZZ") : undefined }}',
                        },
                    },
                },
                type: 'dateTime',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_IMMUTABILITY_POLICY_MODE]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_LEASE_ID]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_LEGAL_HOLD]: '={{ $value?.toString() || undefined }}',
                        },
                    },
                },
                type: 'boolean',
                        ...
                        preSend: [
                            async function (requestOptions) {
                                ...
                                for (const data of metadata.metadataValues) {
                                    requestOptions.headers[`${GenericFunctions_1.HeaderConstants.PREFIX_X_MS_META}${data.fieldName}`] = data.fieldValue;
                                }
                                return requestOptions;
                            },
                        ],
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.ORIGIN]: '={{ $value || undefined }}',
                        },
                    },
                },
                type: 'string',
                    ...
                    send: {
                        preSend: [
                            async function (requestOptions) {
                                ...
                                requestOptions.headers[GenericFunctions_1.HeaderConstants.X_MS_TAGS] = tags.tagValues
                                    .map((tag) => `${encodeURIComponent(tag.tagName)}=${encodeURIComponent(tag.tagValue)}`)
                                    .join('&');
                                return requestOptions;
                            },
                        ],
        ...
        options: [
            ...
            },
            {
                ...
                routing: {
                    request: {
                        headers: {
                            [GenericFunctions_1.HeaderConstants.X_MS_UPN]: '={{ $value?.toString() || undefined }}',
                        },
                    },
                },
                type: 'boolean',
            ...
            operations: {
                async pagination(requestOptions) {
                    ...
                    do {
                        ...
                        executions = executions.concat(responseData[0].json.blobs.map((item) => ({ json: item })));
                    } while (marker);
                    return executions;
                },
            },
