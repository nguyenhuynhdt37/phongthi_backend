...
exports.microsoftEntraNodeResponse = exports.microsoftEntraApiResponse = void 0;
exports.microsoftEntraApiResponse = {
    postGroup: {
...
exports.microsoftEntraNodeResponse = {
    createGroup: [
        {
            json: {
                '@odata.context': 'https://graph.microsoft.com/v1.0/$metadata#groups/$entity',
    ...
    getGroup: [{ json: { ...exports.microsoftEntraApiResponse.getGroup } }],
    getGroupWithProperties: [{ json: { ...exports.microsoftEntraApiResponse.getGroupWithProperties } }],
    updateGroup: [
        {
            json: {
                updated: true,
