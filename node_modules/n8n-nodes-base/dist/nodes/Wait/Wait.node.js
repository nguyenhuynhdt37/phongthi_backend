    ...
    async execute(context) {
        ...
        if (resume === 'timeInterval') {
            ...
            if (isNaN(Date.parse(dateTimeStr))) {
                throw new n8n_workflow_1.NodeOperationError(context.getNode(), '[Wait node] Cannot put execution to wait because `dateTime` parameter is not a valid date. Please pick a specific date and time to wait until.');
            }
